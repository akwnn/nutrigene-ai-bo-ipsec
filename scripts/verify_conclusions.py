...
Covers the quantitative statements in paper/CLAIMS-AND-SOURCES.md and
paper/MANUSCRIPT.md.
...
lc_spec = importlib.util.spec_from_file_location("lc_analysis", "scripts/analyse_lc_confirmatory.py")
LC = importlib.util.module_from_spec(lc_spec); lc_spec.loader.exec_module(LC)
lc_cells, _lc_regret = LC.load(sorted(glob.glob("results/lc-*.json")), LC.ALPHA)
...
print("checked against: paper/CLAIMS-AND-SOURCES.md and paper/MANUSCRIPT.md")
