...
def main() -> int:
    ...
    parser.add_argument("--input", type=Path, default=Path("results/ec-evaluation-current.json"))
    parser.add_argument("--output", type=Path, default=Path("results/paper-figures/portable/fig5-ec-gate.png"))
