...
#: ``research/data/lab`` is split three ways, and the split is load-bearing rather than cosmetic:
#:
...
#: * ``derived/`` -- everything ``software/scripts/build_lab_dataset.py`` writes. Disposable;
...
class LabFile:
    """One committed file under ``research/data/lab``.
