"""Assemble every reader in this package into the derived tables under ``research/data/lab/derived/``.
...
def build_all(lab_root: Path, *, verify: bool = True, long_edge: int = 1024) -> dict:
    """Run every reader and write ``research/data/lab/derived/``. Returns the run summary."""
    ...
    summary = {
        ...
        "promotion_rule": (
            ...
            "bo_primary_conditions.csv is a human act -- see research/data/lab/overlay/GATE.md."
        ),
    }
