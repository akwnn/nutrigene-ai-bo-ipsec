...
that is a convention worth 9-14 percentage points of spread (see ``research/data/lab/overlay/GATE.md``).
...
The signed table is ``research/data/lab/overlay/bo_primary_conditions.csv`` with ``y`` filled and
    ...
    *,
    ...
    if pending:
        raise GatingIncompleteError(
            ...
            f"and have no y. CD31% has not been signed off; see research/data/lab/overlay/GATE.md. "
