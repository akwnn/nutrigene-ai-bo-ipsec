...
`research/results/e3.log` measures the fitted GP's LATENT coverage at nominal 0.95 as 0.8189
...
draws, so it inherits the error exactly (see `software/src/boec/resolution.py` for the volume law
this produces).
