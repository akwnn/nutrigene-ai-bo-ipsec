...
Implements publication/manuscript/PROTOCOLS.md (TT), frozen before this file was written.
...
def main():
    ...
    ap.add_argument("--out", type=Path, default=ROOT / "research" / "results" / "mechanism" / "tt-sweep.json")
