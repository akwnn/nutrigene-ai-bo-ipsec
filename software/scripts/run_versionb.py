...
Registered in `docs/OPEN-QUESTIONS.md` before `software/src/boec/lse.py` existed.
...
**THIS RUNNER NEVER WRITES `research/results/versionb.json`.** That file carries the headline
...
COMMITTED = Path("research/results/versionb.json")
OUT_DEFAULT = Path("research/results/versionb-predictive.json")
