...
**PROVISIONAL.** `research/data/lab/derived/candidate_campaign_coating_flow.csv` carries
`status = awaiting_human_signoff`: the CD31 gate has not been signed by a person, and
`research/data/lab/overlay/GATE.md` is explicit that `bo_primary_conditions.csv`'s `y` stays empty
...
SRC = ROOT / "research/data/lab/derived/candidate_campaign_coating_flow.csv"
