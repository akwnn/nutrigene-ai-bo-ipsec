"""LC adjudicator. Implements publication/manuscript/PROTOCOLS.md (LC) verbatim.
...
def main():
    ...
    ap.add_argument("--glob", default=str(ROOT / "research" / "results" / "comparisons" / "lc-*.json"))
    a = ap.parse_args()
    ...
    print("=== LC adjudication — publication/manuscript/PROTOCOLS.md (LC) ===")
