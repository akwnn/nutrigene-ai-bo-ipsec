"""Reliability and non-vacuity audit for the paper's Figure 5."""
...
def build_figure5(data: dict, preset: VenuePreset) -> FigureBundle:
    ...
    caption = (
        "Figure 5 | Reliability requires both calibration and non-vacuous certification. (a) Retrospective "
    ...
    return FigureBundle("fig5", figure, panel_data, alt_text, caption, long_description)
