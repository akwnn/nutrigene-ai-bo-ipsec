...
- exactly 48 evaluations for SPADE, Sobol48, and qLogNEI48;
- gamma-aware future-response probability maps and certificates;
- positive held-out evidence for certificate willingness and empirical containment;
- a one-shot powered lockbox on four untouched randomized d=6 generator families;
...
- No wet-lab work will occur.
- No biological, GMP, or manufacturing-validation claim.
- No outcome-bearing lockbox access before the selected protocol is committed cleanly.
