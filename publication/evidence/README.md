...
- `publication/manuscript/CLAIMS-AND-SOURCES.md` adjudicates the surviving claims and correction chains;
...
- [`RESULTS-GUIDE.md`](RESULTS-GUIDE.md) explains all main and supporting evidence on one page.
- [`reproduction-map.md`](reproduction-map.md) gives exact commands and expected values.
- [`file-review.csv`](file-review.csv) records the disposition of all 1,402 baseline files.
- [`commit-review.csv`](commit-review.csv) records all 719 baseline commits.
- [`archive/README.md`](../../archive/README.md) explains the preserved historical tree.
