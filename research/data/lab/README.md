...
Before the split, a regenerated table and a corrupted instrument file were the same kind of event — a modified file in `research/data/lab`. Now they are not.
...
The repo already holds synthetic oracles under `research/data/oracles/` and digitized Hall/Ogle tables under `research/data/published/`. This tree is the first in-house drop.
