...
Every file under `research/data/lab/` has a role in `bo_file_roles.csv`. This note is the scientific sort: what the optimizer is allowed to see, what it needs in order to see it, and what must stay out.

> **Update 2026-08-14 — three of the blockers below have been resolved by reading the files.**
> Run `python software/scripts/build_lab_dataset.py` (~31 s) to regenerate `derived/`.
>
