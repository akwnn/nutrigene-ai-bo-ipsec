...
Fully reproducible: `software/scripts/digitize_hall_ogle.py`, raw inputs preserved at
`research/data/external/hall_ogle_2025/fig{1,2}_raw.png`.
...
```
PYTHONPATH=src python software/scripts/digitize_hall_ogle.py \
    --fig1 research/data/external/hall_ogle_2025/fig1_raw.png \
    --fig2 research/data/external/hall_ogle_2025/fig2_raw.png \
    --out research/data/external/hall_ogle_2025
PYTHONPATH=src python -c "from boec.published import write_canonical_csv as w; \
    w('stage1','research/data/published/hall_ogle_2025_stage1.csv'); \
    w('stage2','research/data/published/hall_ogle_2025_stage2.csv')"
pytest software/tests/test_published.py
```
...
at `research/data/external/extraction_a/`, but the code was never supplied, and the erosion
...
at `research/data/external/extraction_a/` and can be *used* and *checked against*, but not
