...
(`scripts/run_replay_hall_ogle.py:72-76`). `tests/test_published_dataset.py` covers the
...
def test_the_second_extraction_is_present(tag):
    """It was reported lost. It was outside the repo, at `data/external/extraction_a/`.
