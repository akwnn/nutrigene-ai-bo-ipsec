...
**Code:** `scripts/run_dc_doe_certificate.py`, `scripts/analyse_dc_doe_certificate.py`  
**Data:** `results/dc-{ackley,hartmann6,hill,levy,rosenbrock}.json`
...
**Code:** `scripts/run_la_round_matched.py`, `scripts/analyse_la_round_matched.py`  
**Data:** `results/la-{ackley,hartmann6,levy,rosenbrock}.json`
...
**Code:** `scripts/run_lc_confirmatory.py`, `scripts/analyse_lc_confirmatory.py`  
**Data:** `results/lc-{ackley,hartmann6,hill,levy,rosenbrock}.json`
...
**Code:** `scripts/run_tau_sweep.py`, `scripts/analyse_tau_sweep.py`  
**Data:** `results/tau-{ackley,hartmann6,hill,levy,rosenbrock}.json`
...
**Code:** `scripts/run_tt_theta_tau.py`, `scripts/analyse_tt_theta_tau.py`  
**Data:** `results/tt-{ackley,hartmann6,hill,levy,rosenbrock}.json`
