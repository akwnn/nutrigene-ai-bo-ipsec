...
- **Canonical results:** `results/dc-{ackley,hartmann6,hill,levy,rosenbrock}.json`.
- **Analysis:** `scripts/analyse_dc_doe_certificate.py`.
- **Guard:** `scripts/verify_conclusions.py`, `tests/test_current_conclusion_guard.py`.
...
- **Frozen protocol:** `paper/PROTOCOLS.md` (DC).
...
- **Canonical results:** `results/lc-*.json`.
- **Analysis:** `scripts/analyse_lc_confirmatory.py`.
- **Guard:** `scripts/verify_conclusions.py`, `tests/test_current_conclusion_guard.py`.
...
- **Canonical results:** SPADE R3 rows in `results/lc-*.json` and LHS rows in
  `results/la-*.json`.
- **Guard:** `scripts/verify_conclusions.py`.
...
- **Canonical results:** `results/tau-{ackley,hartmann6,hill,levy,rosenbrock}.json`.
- **Analysis:** `scripts/analyse_tau_sweep.py`.
- **Guard:** `scripts/verify_conclusions.py`.
...
- **Canonical results:** `results/tt-*.json`.
- **Analysis:** `scripts/analyse_tt_theta_tau.py`.
- **Protocol and interpretation:** `paper/PROTOCOLS.md` (TT).
...
- **In-house code/data:** `scripts/run_real_ipsc_certification.py`, `boec.meanmarg`, and
  `data/lab/derived/candidate_campaign_coating_flow.csv`.
- **Published code/data:** `scripts/certify_hall_ogle.py` and `data/published/`.
...
- **Code:** `scripts/calibrate_real_assay_loo.py`, `scripts/certify_hall_ogle.py`.
