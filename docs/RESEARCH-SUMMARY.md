...
1. Under **measured-value argmax** at the higher-noise condition, sequential DoE attained lower simple regret than qLogEI by 0.0595 at six factors and 0.0284 at eight. Stored qLogNEI does not remove that DoE lead. At lower noise the qLogEI contrast was null. **Q55 decomposes it:** scored on what each arm actually tested, the same contrasts are −0.0158 and −0.0127, so **55–73% of the lead is identification rather than search.** Both arms identify their own best well only 2–18% of the time, and BO’s identification gap is significantly the larger at both σ = 0.25 cells (+0.0436, p = 0.0004 at d = 6). The direction never reverses between the two locators; the magnitude collapses.
